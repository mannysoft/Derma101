<html>
    <head>
        <title>Derma 101 Clinic System</title>
    ...
    <body>
        ...
        if (!isset($_REQUEST["step"])&&!isset($_GET["auto"])) {
            ...
            if (is_installed()) {
                ...
                if ($current_version == $latest_version) {
					...
					$versions_array = array(
											array(	'current' => '0.0.1','sql_file' => 'sql/002.sql','new' => '0.0.2'),
											array(	'current' => '0.0.2','sql_file' => 'sql/002.sql','new' => '0.0.3'),
											array(	'current' => '0.0.3','sql_file' => 'sql/003.sql','new' => '0.0.4'),
											array(	'current' => '0.0.4','sql_file' => 'sql/005.sql','new' => '0.0.5'),
											array(	'current' => '0.0.5','sql_file' => 'sql/006.sql','new' => '0.0.6'),
											array(	'current' => '0.0.6','sql_file' => 'sql/007.sql','new' => '0.0.7'),
											array(	'current' => '0.0.7','sql_file' => 'sql/008.sql','new' => '0.0.8'),
											array(	'current' => '0.0.8','sql_file' => 'sql/009.sql','new' => '0.0.9'),
											array(	'current' => '0.0.9','sql_file' => 'sql/010.sql','new' => '0.1.0'),
											array(	'current' => '0.1.0','sql_file' => 'sql/011.sql','new' => '0.1.1'),
											array(	'current' => '0.1.1','sql_file' => 'sql/012.sql','new' => '0.1.2'),
											array(	'current' => '0.1.1','sql_file' => 'sql/012.sql','new' => '0.1.2'),
											array(	'current' => '0.1.3','sql_file' => 'sql/014.sql','new' => '0.1.4'),
											array(	'current' => '0.1.4','sql_file' => 'sql/015.sql','new' => '0.1.5'),
											array(	'current' => '0.1.5','sql_file' => 'sql/016.sql','new' => '0.1.6'),
											array(	'current' => '0.1.6','sql_file' => 'sql/017.sql','new' => '0.1.7'),
											array(	'current' => '0.1.7','sql_file' => 'sql/018.sql','new' => '0.1.8'),
											array(	'current' => '0.1.8','sql_file' => 'sql/019.sql','new' => '0.1.9'),
											array(	'current' => '0.1.9','sql_file' => 'sql/020.sql','new' => '0.2.0'),
											array(	'current' => '0.2.0','sql_file' => 'sql/021.sql','new' => '0.2.1'),
											array(	'current' => '0.2.1','sql_file' => 'sql/022.sql','new' => '0.2.2'),
											array(	'current' => '0.2.2','sql_file' => 'sql/023.sql','new' => '0.2.3'),
											array(	'current' => '0.2.3','sql_file' => 'sql/024.sql','new' => '0.2.4'),
											array(	'current' => '0.2.4','sql_file' => 'sql/025.sql','new' => '0.2.5'),
											array(	'current' => '0.2.5','sql_file' => 'sql/026.sql','new' => '0.2.6'),
											array(	'current' => '0.2.6','sql_file' => 'sql/027.sql','new' => '0.2.7'),
											array(	'current' => '0.2.7','sql_file' => 'sql/028.sql','new' => '0.2.8'),
											array(	'current' => '0.2.8','sql_file' => 'sql/029.sql','new' => '0.2.9'),
											array(	'current' => '0.2.9','sql_file' => 'sql/030.sql','new' => '0.3.0'),
											array(	'current' => '0.3.0','sql_file' => 'sql/031.sql','new' => '0.3.1'),
											array(	'current' => '0.3.1','sql_file' => 'sql/032.sql','new' => '0.3.2'),
											array(	'current' => '0.3.2','sql_file' => 'sql/033.sql','new' => '0.3.3'),
											array(	'current' => '0.3.3','sql_file' => 'sql/034.sql','new' => '0.3.4'),
											array(	'current' => '0.3.4','sql_file' => 'sql/035.sql','new' => '0.3.5'),
											array(	'current' => '0.3.5','sql_file' => 'sql/036.sql','new' => '0.3.6'),
											array(	'current' => '0.3.6','sql_file' => 'sql/037.sql','new' => '0.3.7'),
											array(	'current' => '0.3.7','sql_file' => 'sql/038.sql','new' => '0.3.8'),
										);
					foreach($versions_array as $version){
						...
						if ($current_version == $version['current']) {
	                        display_information("Upgrading from ".$version['current']." to ".$version['new']);
							execute_sql_file($version['sql_file'],$dbprefix,$con);
			...
			<?php
						...
						$message="Database already has chikitsa installation. Clean it first to continue";
