		...
		<div class="col-md-12">		
			...
			<div class="panel-body">
				<div class="form-group">
					<a class="btn btn-primary" href="<?php echo base_url() . "/index.php/patient/visit/" . $patient_id .'/'.$appointment_id; ?>"><?php echo $this->lang->line("back_to_visit");?></a>
					<a class="btn btn-primary" title="<?php echo $this->lang->line("print");?>" target="_blank" href="<?php echo site_url("patient/print_receipt/" . $visit_id); ?>"><?php echo $this->lang->line("print")." ".$this->lang->line("receipt");?></a>
					<a class="btn btn-primary" title="<?php echo $this->lang->line("payment");?>" href="<?php echo site_url("payment/insert/" . $patient_id . "/bill"); ?>"><?php echo $this->lang->line("bill")." ".$this->lang->line("payment");?></a>
					<a class="btn btn-primary" href="<?php echo site_url("patient/email_bill/" . $visit_id."/".$patient_id ); ?>">Email Bill</a>
							...
							<?php echo form_open('patient/bill/' . $visit_id . '/' . $patient_id) ?>
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<div class="col-md-3">
											<button class="btn btn-primary" type="submit" name="submit" value="discount" /><?php echo $this->lang->line("add");?></button>
										</div>
									</div>
								</div>
										...
										<?php 
											...
											if ($bill_details != NULL) {                 
												...
												<tr <?php if ($i % 2 == 0) { echo "class='alt'";} ?> >
													...
													<td><a class="btn btn-sm btn-danger square-btn-adjust confirmDelete"  title="<?php echo "Delete : " . $bill_detail['particular'] ?>" href="<?php echo site_url("patient/delete_bill_detail/" . $bill_detail['bill_detail_id'] . "/" . $bill_id . "/" . $visit_id . "/" . $patient_id); ?>"><?php echo $this->lang->line("delete");?></a></td>
												</tr>
												<?php } ?>
											<?php $i++; ?>
											<?php } ?>
