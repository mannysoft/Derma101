	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-primary" >
						...
						<div class="col-md-4" >
							<div class="form-group" >
								<select name="default_language" class="form-control" >
										...
										if ($key !== 0) {?>
										<option value="<?php echo $key; ?>" <?php if($this->config->item('language') == $key) { ?>selected="selected"<?php } ?>><?php echo $key; ?></option>
										<?php }}?>
								</select>
							</div>
						</div>
				...
				<?php echo form_close(); ?>
				<?php echo form_open('settings/enable_ad'); ?>
					<div class="col-md-12">
						<div class="col-md-12">
							<label for="enable_ad">Display Google Ads</label> 
					...
					<div class="col-md-12">
						<div class="col-md-4">
							<div class="form-group">
								...
								echo form_checkbox('enable_ad', 1, $checked,'class="form-control"'); ?>
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group" >
