		...
		<div class="col-md-12">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<span style="margin-right:15px;" class="fa fa-calendar fa-1x"> </span><input type="text" id="select_date" name="select_date" value="<?=date('d F Y, l', strtotime($day . "-" . $month . "-" . $year));?>"/>
					<?php $day_date=$day; ?>
				</div>
					...
					<div class="table-responsive"  style='position:relative;overflow:auto;'>
						...
						<table class="table table-condensed table-striped table-bordered table-hover dataTable no-footer"  >
								...
								<tr>
									...
									foreach ($doctors as $doctor) { 
										if (strlen($doctor['name'])>12){ 
											$doctor_name = "Dr."." ".substr($doctor['name'],0,18) ;
										}else{
							...
							<tbody>
								...
								?>
									<div id="<?=$appointment_id;?>" start_position="<?=$start_position;?>" end_position="<?=$end_position;?>" appointment_column="<?=$appointment_column;?>"  style="display:none;" >
										<a href='<?=$href;?>' title="<?=$appointment['title'];?>" class="btn square <?=$class;?> " style="height:100%;">
											<?= $appointment_title;?>
										</a>
									</div>
			...
			?>
			<div class="appointment_legend">
			<h4>Legend</h4>
				<div class="legend">
					<span class="btn square-btn-adjust btn-primary">&nbsp;</span><span><?=$this->lang->line('appointment');?></span>
				</div>
				<div class="legend">
					<span class="btn square-btn-adjust btn_pending">&nbsp;</span><span><?=$this->lang->line('pending');?></span>
				</div>
				<div class="legend">
					<span class="btn square-btn-adjust btn-warning">&nbsp;</span><span><?=$this->lang->line('waiting');?></span>
				</div>
				<div class="legend">
					<span class="btn square-btn-adjust btn-danger">&nbsp;</span><span><?=$this->lang->line('consultation');?></span>
				</div>
				<div class="legend">
					<span class="btn square-btn-adjust btn-success">&nbsp;</span><span><?=$this->lang->line('complete');?></span>
				</div>
				<div class="legend">
					<span class="btn square-btn-adjust btn-info">&nbsp;</span><span><?=$this->lang->line('cancelled');?></span>
				</div>
				<div class="legend">
					<span class="btn square-btn-adjust btn-grey">&nbsp;</span><span><?=$this->lang->line('not_available');?></span>
				</div>
