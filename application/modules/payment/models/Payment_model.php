...
class Payment_model extends CI_Model {
    ...
    public function __construct() {
   	...
   	public function getPayment($offset, $limit, $sort, $type = "list"){
        $this->db->order_by("pay_date", "desc");
		$this->db->select("*");
		$this->db->join("patient", 'patient.patient_id = payment.patient_id', 'left');
   		...
   		if($sort){
   			...
   			$this->db->or_like("pay_mode", $sort, "both");
   		}
