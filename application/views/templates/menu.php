    ...
    <div class="sidebar-collapse">
        ...
        <ul class="nav" id="main-menu">
			...
			foreach ($result_top_menu as $top_menu):
				...
				<li>
					<a href="<?= site_url( $top_menu['menu_url'] ); ?>" <?php if($current_page == $top_menu['menu_url']) echo "class='active-menu'";?>><i class="fa <?php echo $top_menu['menu_icon']; ?> fa-lg"></i><?php echo $top_menu['menu_text'];  ?></a>
					<?php 
						//Select all Childs
