		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					...
					<?php }?>
					<div class="col-md-12 patient_fullname">
						<div class="col-md-3">
					...
					<div class="col-md-12">
						<div class="col-md-6">
							<div class="form-group" >
								...
								<input name="display_id" class="form-control" value="<?php echo $display_id; ?> " disabled/>
							...
							<div class="form-group">
								<label for="reference_by">Referred by</label>
							...
							<div class="form-group">
								...
								<input type="email" name="email" class="form-control" value="<?php  echo $contact_email; ?>"/><br/>
